      ...
      <main>
        ...
        <section className="ServicesContainer" id="nos-services">
          ...
          <div className="ListContainer">
            <ServiceCard imageSrc="https://pierre-le-developpeur.com/724/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png">
            ...
            <ServiceCard imageSrc="https://pierre-le-developpeur.com/724/images/hall-expo.png">
              <h3>Conférences</h3>
            ...
            <ServiceCard imageSrc="https://pierre-le-developpeur.com/724/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
        ...
        <section className="PeoplesContainer" id="notre-equipe">
          ...
          <div className="ListContainer">
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.png"
              name="Samira"
              position="CEO"
            />
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.png"
              name="Jean-baptiste"
              position="Directeur marketing"
            />
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.png"
              name="Alice"
              position="CXO"
            />
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.png"
              name="Luís"
              position="Animateur"
            />
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/amy-hirschi-b3AYk8HKCl0-unsplash1.png"
              name="Christine"
              position="VP animation"
            />
            <PeopleCard
              imageSrc="https://pierre-le-developpeur.com/724/images/christina-wocintechchat-com-0Zx1bDv5BNY-unsplash.png"
              name="Isabelle"
